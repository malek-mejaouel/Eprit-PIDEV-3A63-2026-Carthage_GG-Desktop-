...
public class GoogleAuthService {
    ...
    private static String resolveClientId() {
        ...
        throw new IllegalStateException("Google OAuth Client ID not configured. Please set the environment variable: " + ENV_CLIENT_ID);
    }
    ...
    private static String resolveClientSecret() {
        ...
        if (env != null && !env.isBlank()) return env.trim();
        throw new IllegalStateException("Google OAuth Client Secret not configured. Please set the environment variable: " + ENV_CLIENT_SECRET);
    }
}
